...
# =======================
func _add_room_features(room: RoomsSystem.Room, template: RoomTemplate, tilemap: TileMapLayer):
...
func _add_pillars(room: RoomsSystem.Room, tilemap: TileMapLayer):
...
func _add_water_pool(room: RoomsSystem.Room, tilemap: TileMapLayer):
...
func _add_raised_area(room: RoomsSystem.Room, tilemap: TileMapLayer):
...
func _add_pit(room: RoomsSystem.Room, tilemap: TileMapLayer):
	"""Agrega un foso"""
...
func _add_altar(room: RoomsSystem.Room, tilemap: TileMapLayer):
...
func _is_position_valid_for_feature(room: RoomsSystem.Room, pos: Vector2i) -> bool:
...
func _setup_spawn_points(room: RoomsSystem.Room, template: RoomTemplate):
...
#  API PÚBLICA
# =======================
func get_spawn_points_for_room(room: RoomsSystem.Room) -> Array[Vector2i]:
...
#  DEBUG
# =======================
func debug_room_info(room: RoomsSystem.Room):
